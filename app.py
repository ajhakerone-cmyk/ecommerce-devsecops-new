...
PRODUCTS = {
    ...
    '2': {
        ...
        'description': '6.8" AMOLED, 200MP Camera, 5000mAh',
        'stock': 15
    },
    '3': {
        'id': '3',
    ...
    '4': {
        ...
        'description': 'M2 chip, 256GB, Liquid Retina',
        'stock': 8
    },
    '5': {
        'id': '5',
    ...
    '6': {
        ...
        'description': '8K DPI, Silent clicks',
        'stock': 25
    }
}
...
def place_order():
    try:
        ...
        # Calculate totals and create items list
        subtotal = 0.0
        order_items = []
        ...
        # Create order object with simple structure
        order = {
            'order_id': order_id,
            'customer_name': data['name'],
            'customer_email': data['email'],
            'customer_phone': data['phone'],
            'customer_address': f"{data['address']}, {data['city']}, {data['state']} {data['zip']}, {data['country']}",
            'items': order_items,  # This is a list
            'subtotal': round(subtotal, 2),
            'shipping': round(shipping, 2),
            'tax': round(tax, 2),
            'total': round(total, 2),
        ...
        print("Order items length:", len(order['items']))
